...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    public void startOpenCameraVideo2() {
        //todo 开启相机
        //开始拍照
        Intent intent = new Intent(PictureSelectorActivity.this, VideoCameraActivity.class);
        config.mimeType = PictureConfig.TYPE_VIDEO;
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                ...
                case PictureConfig.REQUEST_CAMERA:
                    if (config.mimeType == PictureConfig.TYPE_VIDEO) {
